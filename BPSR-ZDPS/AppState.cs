...
namespace BPSR_ZDPS
{
    public static class AppState
    {
        ...
        /// <summary>
        /// Merges the key/value pairs from the given AppStrings file (in the Data dir) into
        /// <paramref name="target"/>, overwriting existing keys. Returns false if the file is absent.
        /// </summary>
